        ...
        <div class="tab-pane active" id="peopleData_tab">
            <form id="editPassword" action="updatePassword" method="post" data-toggle="validator" role="form">
                <div class="row form-group">
                    ...
                    <div class="col-xs-9">
                        <input type="password" id="oldPassword" name="oldPassword" placeholder="请输入6-16位密码" rangelength="[6,16]" checkPassword="true"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-xs-9">
                        <input type="password" id="newPassword2" name="newPassword2" placeholder="确认新密码" rangelength="[6,16]" equalTo="#newPassword1"
                               class="form-control" required/>
                    </div>
                </div>
                <div class="row form-group">
