<div class="col-md-12" id="goodsBaseInfoDetail" style="display: none;">
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title" id="updateTitle">审核商品基本信息</h3>
        ...
        <form id="detailForm" class="form-horizontal" method="post" action="save" data-toggle="validator"
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <label for="" class="col-sm-1 control-label"><span style="color: red;">&nbsp;*</span>&nbsp;&nbsp;商品小类</label>
                    <div class="col-sm-2">
        ...
        <@shiro.hasPermission name="goods:reviewBasiInfo">
            <div class="box-footer">
                <button type="button" class="btn btn-default pull-right btn-cancel">
                    <i class="fa fa-reply"></i> 取消
                </button>
                <button type="button" class="btn btn-success pull-right" onclick="reviewSuccess()">
                    <i class="fa fa-check"></i> 通过
                </button>
                <button type="button" class="btn btn-danger pull-right " onclick="reviewFail()">
