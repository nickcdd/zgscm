 ...
 */
public class SendOrdersExcelView extends AbstractXlsxView {
...
//                row.createCell(j++).setCellValue(orders.getSid());
                    row.createCell(j++).setCellValue(ordersGoods.getGoodsSpecification().getGoodsBm().toString());
                    ...
                    row.createCell(j++).setCellValue(ordersGoods.getGoodsSpecificationPrice().toString());
