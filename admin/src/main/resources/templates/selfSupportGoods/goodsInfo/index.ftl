...
<#include "/_head_with_table.ftl" />
    ...
    <meta name="nav-url" content="/selfSupportGoods/goodsInfo/index">
...
//            alert($(obj).val());
        ...
        function uploadExcel() {
            ...
            $("#excelForm").ajaxSubmit({
                type: "POST",
                url: "/selfSupportGoods/uploadFile",
                dataType: "json",
                success: function (data) {
                    if (data.flag) {
...
//                }
        ...
        function checkGoodsBm(goodsBm,specificationSid){
            ...
            if(goodsBm.trim()!="" && goodsBm!=undefined && goodsBm!=null) {
                ...
                $.ajax({
                    type: "POST",
                    url: '/selfSupportGoods/checkGoodsBm',
                    async: false,
            ...
            <div class="box-body">
                <div class="row placeholders">
                    <div class="col-md-12 placeholders">
                        <form id="infoForm" action="/selfSupportGoods/goodsInfo/index" method="post" class="form-inline"
                              role="search-form">
...
<#-- 显示供应商详情 -->
<#include "/selfSupportGoods/goodsInfo/detail.ftl" />
</div>
