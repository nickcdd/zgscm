<script src="/assets/js/selfSupportGoods/goodsInfo/detail.js"></script>
<div class="col-md-12" id="goodsBaseInfoDetail" style="display: none;">
    <div class="box box-info">
        ...
        <form id="detailForm" class="form-horizontal" method="post" action="/selfSupportGoods/goodsInfo/save" enctype="multipart/form-data"
        ...
        <@shiro.hasPermission name="selfSupport:goodsManager">
            <button type="button" class="btn btn-primary pull-right" id="commitButton" onclick="commitFrom()">
                <i class="fa fa-save"></i> 保存
            </button>
            <button type="button" class="btn btn-info pull-right " id="reviewBtn" onclick="commitFrom(2)">
