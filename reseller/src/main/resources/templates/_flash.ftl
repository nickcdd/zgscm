...
<#if ERROR_MESSAGE?? || RequestParameters.ERROR_MESSAGE??>
    <#if !ERROR_MESSAGE??>
        <#assign ERROR_MESSAGE=RequestParameters.ERROR_MESSAGE />
    </#if>
...
<#if INFO_MESSAGE?? || RequestParameters.INFO_MESSAGE??>
    <#if !INFO_MESSAGE??>
        <#assign INFO_MESSAGE=RequestParameters.INFO_MESSAGE />
    </#if>
