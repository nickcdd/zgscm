package com.cqzg168.scm.reseller.shiro.filter;

import com.cqzg168.scm.reseller.shiro.exception.IncorrectCaptchaException;
...
public class CaptchaFormAuthenticationFilter extends FormAuthenticationFilter {
    ...
    protected void doCaptchaValidate(HttpServletRequest request, AuthenticationToken token) {
        ...
        if (captchaFromRequest == null || captchaFromSession == null || !captchaFromSession.equalsIgnoreCase(captchaFromRequest)) {
