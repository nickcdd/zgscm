<div class="col-md-12" id="reviewPriceDetail" style="display: none;">
    <div class="box box-info">
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="cname" name="cname" placeholder="商品名称"
                               required="required" maxlength="50" autocomplete="false" readonly/>
        ...
        <@shiro.hasPermission name="goods:reviewGoods">
