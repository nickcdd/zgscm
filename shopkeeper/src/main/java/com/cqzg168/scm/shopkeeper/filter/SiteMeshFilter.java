package com.cqzg168.scm.shopkeeper.filter;
...
public class SiteMeshFilter extends ConfigurableSiteMeshFilter implements DecoratorSelector<WebAppContext> {
    ...
    protected void applyCustomConfiguration(SiteMeshFilterBuilder builder) {
        ...
        this.excludesMapper.put("/cashier/*", true);
        this.excludesMapper.put("/order/page", true);
        this.excludesMapper.put("/goods/page", true);
    }
