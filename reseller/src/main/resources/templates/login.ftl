...
<div class="container-fluid">
    ...
    <div class="row" style="margin-top: 5%;">
        ...
        <div class="pull-right">
            <h1 style="color: #ef822c; font-size: 50px;">正格集采品台分销商端</h1>
        </div>
        <div class="pull-right">
    ...
    <div class="row box-login" style="padding: 100px;">
        <div class="pull-right" style="margin-right: 100px;">
            <div style="width: 450px; height: 293px;">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#password_login" data-toggle="tab" aria-expanded="true">密码登录</a>
                        </li>
                        <li class="">
                            <a href="#sms_login" data-toggle="tab" aria-expanded="false">短信验证登录</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                            ...
                            <form action="/login" method="post" class="form-signin form-bg-ljq">
                                <div class="form-group">
                                    ...
                                    <span class="input-group-addon">
                                        ...
                                        <input type="text" id="name" name="username" class="form-control input-lg"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-5">
                                            <img src="/captcha" class="img-responsive" title="图形验证码"
                        ...
                        <!--短信登录-->
                        <div class="tab-pane" id="sms_login">
                            <form action="/smsLogin" method="post" class="form-signin form-bg-ljq" data-toggle="validator"
                                  role="form">
                                <div class="form-group">
                                    <div class="input-group">
                                    <span class="input-group-addon">
                                        ...
                                        <input type="text" name="telephone" id="telephone" digits="true" isMobile="true" class="form-control input-lg" placeholder="电话号码" required
                                               autofocus>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-5">
                                            <img src="/smsCode" class="img-responsive" title="图形验证码"
                                                 onclick="this.src='/captcha?rnd=' + Math.random();"
                                                 style="cursor: pointer;" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-7">
                                            ...
                                            <span class="input-group-addon">
                                                ...
                                                <input type="text" name="smsCode" class="form-control input-lg" placeholder="短信验证码"
                                                       required>
                                            </div>

                                        </div>
                                        <div class="col-xs-5">
                                            <button type="button" onclick="SMS()" class="btn btn-success btn-block btn-lg"
                                                    id="smsCodeButton">获取验证码
                                            </button>
                                        </div>
                                    </div>
