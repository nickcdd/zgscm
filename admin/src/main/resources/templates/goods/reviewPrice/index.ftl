...
<#include "/_head_with_table.ftl" />
    ...
    <meta name="nav-url" content="/goods/reviewPrice/index">
    <script src="/assets/js/goods/reviewPrice/index.js"></script>
    ...
    <div class="col-md-12" id="reviewPriceList">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">商品列表审核价格</h3>
            </div>
                ...
                <div class="row placeholders">
                    <div class="col-md-12 placeholders">
                        ...
                        <#--</div>-->
                            ...
                            <div class="form-group ">
                                <button type="button" class="btn btn-success btn-block btn-sign" onclick="batchBtns(7)"> <i class="fa fa-check"></i>批量通过
                                </button>
                            </div>
                            <div class="form-group ">
                                <button type="button" class="btn btn-danger btn-block btn-sign" onclick="batchBtns(6)"><i class="fa fa-close"></i>批量不通过
                                </button>
                            </div>
                                ...
                                <table id="infoTable" data-toggle="table" data-page-info='${pageInfo}'
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <button type="button" class="btn btn-success btn-xs" value="${g.sid?c}" onclick="singleBtn(this,7)">
                                                <i class="fa fa-check"></i> 通过
                                            </button>
                                            <button type="button" class="btn btn-danger btn-xs" value="${g.sid?c}" onclick="singleBtn(this,6)">
...
<#-- 显示详情 -->
<#include "/goods/reviewPrice/detail.ftl" />
</div>
</body>
</html>