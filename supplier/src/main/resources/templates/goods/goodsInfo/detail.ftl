<script src="/assets/js/goods/goodsInfo/detail.js"></script>
<div class="col-md-12" id="goodsBaseInfoDetail" style="display: none;">
    <div class="box box-info">
        ...
        <form id="detailForm" class="form-horizontal" method="post" action="/goods/goodsInfo/save" enctype="multipart/form-data"
